...
const Intro = () => {
    return (
        <div className='w-full h-screen text-center md:mb-0 mb-10' id='intro'>
                ...
                <div className='sm:mt-[0] mt-[100px]'>
                    {
                        BriefIntro.map((Value) => (
                            <>
                                <div className='relative shadow-lg shadow-gray-800 rounded-[5px] rounded-bl-[70px] rounded-br-[150px] rounded-tl-[100px] mx-auto w-[20rem] h-[20rem] hover:scale-[1.1] duration-300 md:mt-9 mt-0 overflow-hidden hover:border-[5px] ' style={{ borderRadius:" 55% 45% 70% 30% / 44% 80% 20% 56%  " }} >
                                ...
                                <h1 className='py-1  text-gray-700'><span className='text-[#5651e5] '>
                                    {Value.name}</span></h1>
                                <p className=' md:w-[70%] md:px-[auto] pl-[20px] mx-[auto] text-gray-700'>{Value.role}</p>
