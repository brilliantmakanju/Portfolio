                ...
                <div className=''>
                    {
                        BriefIntro.map((Value) => (
                            <>
                                <div className='relative bg-gray-300 shadow-lg shadow-gray-800 rounded-[5px] rounded-bl-[70px] rounded-br-[150px] rounded-tl-[100px] mx-auto w-[20rem] h-[20rem] md:hover:scale-[1.1] duration-300 md:mt-9 mt-0 overflow-hidden hover:border-[5px] ' style={{ borderRadius: " 55% 45% 70% 30% / 44% 80% 20% 56%  " }} >
                                    <Image src="/projects/Alkis.png" fill className='absolute  object-fill ' />
                                </div>

                                {/* <p className='uppercase text-sm tracking-widest text-gray-500 ' >{Value.quote}</p> */}
                                <h1 className='py-1 w-screen text-[#5651e5] px-[.4px]  '>{Value.name}</h1>
